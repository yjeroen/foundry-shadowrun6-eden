...
export class SR6Config {
    ...
    MATRIX_ACTIONS = {
        ...
        change_icon: new MatrixAction("change_icon", null, null, null, false, false, false, true, true, undefined, null, null, -1),
        ...
        enter_host: new MatrixAction("enter_host", null, null, null, false, true, true, true, true, null, null),
        erase_matrix_signature: new MatrixAction("erase_matrix_signature", "electronics", "computer", "log", true, true, false, true, true, "wil", "f"),
        format_device: new MatrixAction("format_device", "electronics", "software", "log", true, true, false, false, true, "wil", "f"),
        ...
        probe: new MatrixAction("probe", "cracking", "hacking", "log", true, true, true, true, false, "wil", "f", "s"),
        ...
        tarpit: new MatrixAction("tarpit", "cracking", "cybercombat", "log", true, true, false, true, true, "d", "f", "a"),
