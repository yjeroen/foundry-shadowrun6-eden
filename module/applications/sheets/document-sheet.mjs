...
/**
 * Augments a Document Sheet ApplicationV2 with SR6 specific behavior.
 * This includes drag and drop, play/edit mode
 */
export default class SR6DocumentSheet extends api.HandlebarsApplicationMixin(api.DocumentSheet) {
  /** @inheritdoc */
  static DEFAULT_OPTIONS = {
    classes: ["shadowrun6", "sr6"],
    form: {
      submitOnChange: true,
      closeOnSubmit: false,
    },
    ...
    actions: {
      toggleMode: SR6DocumentSheet.#toggleMode,
      viewDoc: SR6DocumentSheet.#viewDoc,
      createDoc: SR6DocumentSheet.#createDoc,
      deleteDoc: SR6DocumentSheet.#deleteDoc,
      toggleDocumentDescription: SR6DocumentSheet.#toggleDocumentDescription,
      updateFromCompendium: SR6DocumentSheet.#updateFromCompendium,
    },
   ...
   * @type {typeof SR6DocumentSheet.MODES[keyof typeof SR6DocumentSheet.MODES]}
   * @protected
   */
  _mode = SR6DocumentSheet.MODES.PLAY;
   ...
   */
  get isPlayMode() {
    return this._mode === SR6DocumentSheet.MODES.PLAY;
  }
   ...
   */
  get isEditMode() {
    return this._mode === SR6DocumentSheet.MODES.EDIT;
  }
  ...
  _configureRenderOptions(options) {
    ...
    else if (options.renderContext === `create${this.document.documentName}`) this._mode = SR6DocumentSheet.MODES.EDIT;
  }
  ...
  static async #toggleMode(event, target) {
    ...
    await this.render({ mode: this.isPlayMode ? SR6DocumentSheet.MODES.EDIT : SR6DocumentSheet.MODES.PLAY });
  }
