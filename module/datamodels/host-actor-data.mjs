...
export default class SR6HostActorData extends SR6BaseActorData {
    ...
    static defineSchema() {
        ...
        return {
            ...
            securityResponse: new fields.HTMLField(),
    ...
    get tokenType() {
        const tokenType = this.parent.token?.getFlag("shadowrun6-eden", 'tokenType'); // TODO JEROEN unclear yet if this should be the Item uuid instead and then add a getter
        return tokenType;
    }
